...
public class CountDiff0 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
//		String str1=getdiffClientNum("diff0.txt");
//		System.out.print("str1="+str1);
		HashSet<String> lists = getListSet("C:/Research/XNIO/diff0.txt");
	    ...
	    if (args.length>0) {
			...
			//writeSet(availableList,args[0]);			
	    }	

		//writeSet(availableList,"C:/Research/XNIO/diffAvailable.txt");
	}
