...
MAINCP=".:$JAVA_HOME/jre/lib/rt.jar:$ROOT/libs/soot-trunk.jar:$ROOT/DUA1.jar:$ROOT/DUAForensics-bins-code/InstrReporters:$ROOT/DUAForensics-bins-code/LocalsBox:$ROOT/DistTaint.jar:$INDIR:$subjectloc/DT2Instrumented/classes:$subjectloc/conf:$subjectloc/dist/voldemort-contrib-1.10.26.jar"
