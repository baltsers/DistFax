...
INDIR=$ROOT/zookeeper/DTInstrumented
...
MAINCP=".:$ROOT/DUA1.jar:$ROOT/DistTaint.jar:$ROOT/libs/soot-trunk.jar:$subjectloc/conf:$INDIR"
echo $MAINCP
...
#	MAINCP=$MAINCP:$i
#done
# MAINCP=$MAINCP:$ROOT/Zookeeper/distEAInstrumented
suffix="zk"
