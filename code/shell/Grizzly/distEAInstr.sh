...
#SOOTCP=".:$JAVA_HOME/jre/lib/rt.jar:$ROOT/thrift/0110/lib/java/build:$ROOT/thrift/java3/bin:$ROOT/libs/DistEA5.jar"

SOOTCP=".:$JAVA_HOME/jre/lib/rt.jar:$ROOT/thrift/0100/lib/java/build:$ROOT/thrift/java/bin:$ROOT/distEA.jar"
suffix="thrift"
...
java -Xmx100g -ea -cp ${MAINCP} distEA.distEAInst \
	...
	-dumpJimple \
	-dumpFunctionList \
    -process-dir  $ROOT/thrift/0100/lib/java/build  \
         -process-dir  $ROOT/thrift/java/bin  \
	1> $logout 2> $logerr
